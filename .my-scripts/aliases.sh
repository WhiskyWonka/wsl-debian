...
alias sshdev='ssh -i /mnt/d/BOLDT/SERVIDORES/DEV\ AWS/dev_aws/aws_boldt_bplay_bplaybet_development ubuntu@44.215.207.90'
alias sshuat='ssh -i ssh -i /mnt/d/BOLDT/SERVIDORES/DEV\ AWS/uat_aws/aws_boldt-bplay-bplaybet-qa_web_key.pem ubuntu@34.203.37.180'
